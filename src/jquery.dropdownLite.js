 ...
 * $body.data('ddl').addWidget($new_widget) = this is the function you would use to add new widgets to share the body element
 * 
...
$.fn.dropdownLite = function(map) {
    var opts = $.extend({}, {
        ...
        onShowBody: function($widget) {},
        onHideBody: function() {}, //this happens when body is hidden
        ...
        positionOf: function($widget){ //we postion around this element, see the 'of' property in the position plugin. override if needed
            return $widget;
        }
    }, map || {});
...
/**
 * 
 * hover plugin: show dropdown on hover of 'delayMs'
 * 
 * @param map
 * @return {*}
 */
